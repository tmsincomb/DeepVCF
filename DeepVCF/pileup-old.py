...
class Pileup:
    ...
    def _meets_filter(self, total_count: int, base_count: list, ref_base: str):
        ...
        if (p0 < 1.0 - self.heterozygous_threshold and p1 > self.heterozygous_threshold) and base_count[0][0]:   
            return 1
        return 0
    ...
    def get_contig_pileup(self):
        ...
        ref_seq_seg = self.ref_seq[self.contig_start:self.contig_end+1]
        ref_piles = []
        vpos = -float('inf')
